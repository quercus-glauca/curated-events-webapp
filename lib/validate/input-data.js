...
// ProfileData
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
export function validateChangeProfileData(changeProfileData) {
  let inputAccepted, rejectedDetails;

  if (changeProfileData.change.name) {
    [inputAccepted, rejectedDetails] = validateInputText(changeProfileData.change.namee, 'new user name');
    if (!inputAccepted) {
      return [inputAccepted, rejectedDetails];
    }
  }

  if (changeProfileData.change.password) {
    [inputAccepted, rejectedDetails] = validateInputPassword(changeProfileData.change.password);
    if (!inputAccepted) {
      return [inputAccepted, rejectedDetails];
    }
  }

  return [true, 'Change profile data admitted'];
}
